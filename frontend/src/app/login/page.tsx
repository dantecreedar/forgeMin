        ...
        <div className="bg-slate-900/80 border border-slate-800/90 backdrop-blur-xl rounded-3xl p-8 shadow-2xl text-center space-y-6">
          ...
          <div className="space-y-3 pt-2">
            ...
            <motion.button
              ...
              className="w-full bg-white hover:bg-slate-100 text-slate-900 rounded-2xl px-5 py-3.5 text-xs font-bold flex items-center justify-between transition-all shadow-md group"
            >
              ...
              <span className="text-[10px] bg-blue-50 text-blue-700 font-semibold px-2 py-0.5 rounded-full flex items-center gap-1">
                <ShieldCheck size={10} /> Acceso a Gestión
              </span>
            </motion.button>
            ...
            <motion.button
              ...
              className="w-full bg-slate-800/90 hover:bg-slate-800 text-white border border-slate-700/80 rounded-2xl px-5 py-3.5 text-xs font-bold flex items-center justify-between transition-all shadow-md group"
            >
              <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] bg-slate-700/80 text-amber-300 font-semibold px-2 py-0.5 rounded-full flex items-center gap-1">
